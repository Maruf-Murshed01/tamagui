import { Heart, Mail, Moon, Send, Sparkles, Star, Sun, Zap } from '@tamagui/lucide-icons';
import { useState } from 'react';
import { Button, Card, H3, Input, ScrollView, Text, Theme, XStack, YStack } from 'tamagui';
  ...
  return (
    <Theme name={theme}>
      ...
      >
        ...
        >
          {/* Theme Toggle Button */}
          <XStack position="absolute" top="$4" right="$4" zIndex="$5">
            <Button
              size="$3"
              circular
          ...
          {/* Email Compose Card - colors automatically adapt */}
          <Card
            elevate
            bordered
          ...
          <YStack space="$1" alignItems="center" marginTop="$4" marginBottom="$6">
            ...
            <XStack space="$1">
              <Text fontSize={12} color="$success">●</Text>
